...
static const _TerrainGrid_type_support_symbol_names_t _TerrainGrid_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rover_perception_msgs, msg, TerrainGrid)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rover_perception_msgs, msg, TerrainGrid)),
  }
};
...
{
  return &::rover_perception_msgs::msg::rosidl_typesupport_cpp::TerrainGrid_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rover_perception_msgs, msg, TerrainGrid)() {
  return get_message_type_support_handle<rover_perception_msgs::msg::TerrainGrid>();
}
