...
static rosidl_typesupport_introspection_c__MessageMember rover_control_msgs__msg__OperationalModeSettings__rosidl_typesupport_introspection_c__OperationalModeSettings_message_member_array[4] = {
  {
    "stereo_cam",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rover_control_msgs__msg__OperationalModeSettings, make_global_pointcloud),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
