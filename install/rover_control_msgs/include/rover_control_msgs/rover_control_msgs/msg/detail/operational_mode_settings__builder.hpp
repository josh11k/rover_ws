...
class Init_OperationalModeSettings_make_global_pointcloud
{
public:
  explicit Init_OperationalModeSettings_make_global_pointcloud(::rover_control_msgs::msg::OperationalModeSettings & msg)
  : msg_(msg)
  {}
  ::rover_control_msgs::msg::OperationalModeSettings make_global_pointcloud(::rover_control_msgs::msg::OperationalModeSettings::_make_global_pointcloud_type arg)
  {
    msg_.make_global_pointcloud = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_OperationalModeSettings_make_global_pointcloud lidar(::rover_control_msgs::msg::OperationalModeSettings::_lidar_type arg)
  {
    msg_.lidar = std::move(arg);
    return Init_OperationalModeSettings_make_global_pointcloud(msg_);
  }
