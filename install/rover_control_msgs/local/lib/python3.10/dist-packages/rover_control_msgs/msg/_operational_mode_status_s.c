...
bool rover_control_msgs__msg__operational_mode_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rover_control_msgs.msg._operational_mode_status.OperationalModeStatus", full_classname_dest, 69) == 0);
  }
  rover_control_msgs__msg__OperationalModeStatus * ros_message = _ros_message;
  {  // stereo_cam
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * rover_control_msgs__msg__operational_mode_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of OperationalModeStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rover_control_msgs.msg._operational_mode_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OperationalModeStatus");
  ...
  rover_control_msgs__msg__OperationalModeStatus * ros_message = (rover_control_msgs__msg__OperationalModeStatus *)raw_ros_message;
  {  // stereo_cam
    PyObject * field = NULL;
