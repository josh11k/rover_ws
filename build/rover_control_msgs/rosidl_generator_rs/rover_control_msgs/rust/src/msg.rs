...
pub struct OperationalModeSettings {
    ...
    // This member is not documented.
    #[allow(missing_docs)]
    pub make_global_pointcloud: std::string::String,
...
impl rosidl_runtime_rs::Message for OperationalModeSettings {
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        make_global_pointcloud: msg.make_global_pointcloud.as_str().into(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        stereo_cam: msg.stereo_cam.as_str().into(),
        mono_cam: msg.mono_cam.as_str().into(),
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      ...
      make_global_pointcloud: msg.make_global_pointcloud.to_string(),
    }
  }
}
