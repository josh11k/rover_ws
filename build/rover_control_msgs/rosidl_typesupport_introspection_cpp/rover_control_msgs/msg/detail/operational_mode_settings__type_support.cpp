...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OperationalModeSettings_message_member_array[4] = {
  {
    "stereo_cam",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rover_control_msgs::msg::OperationalModeSettings, make_global_pointcloud),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
